...
class EWAP_ethDataSet(data.Dataset):
    def __init__(self, crf, gop, seq=['3']):
        folders = seq
        self.ref = []
        self.refbpp = []
        self.input = []
        ...
        for seq in folders:
            seq = seq.rstrip()
            root = '/ai/base/data/wangfuchun/PyTorchVideoCompression/DVC/data/surveillance/ewap_hotel'
            seqIbpp = 1.0
            ...
            experiment_dir = f'/ai/base/data/wangfuchun/PyTorchVideoCompression/DVC/examples/pre_trained_dvc/data/surveillance/ffmpeg/h265/ewap_hotel/{seq}/gop_experiments/crf_{crf}_gop_{gop}'
